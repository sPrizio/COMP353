...
<div class="row">
    ...
    <div class="col s3 align-right">
        ...
        <a href='{{ URL("/employee/{$employee->id}/delete") }}' class="waves-effect waves-dark btn">
...
<div class="row">
    ...
    <div class="col s6">
        ...
        <div class="attribute-container">
            ...
            <p class="attribute">
                Department: <a href='{{ URL("/department/view/{$employee->department_id}") }}'>{{ Helper::getDepartmentName($employee->department_id, $departments) }}</a>
            </p>
        </div>
    </div>
    <div class="col s6">
    ...
    <div class="col s6">
        ...
        <div class="attribute-container">
            ...
            @if (is_null($supervisor))
                Supervisor: None
            @else
                Supervisor: <a href='{{ URL("/employee/view/{$supervisor->id}") }}'>{{ $supervisor->first_name }} {{ $supervisor->last_name }}</a>
            @endif
            </p>
        @if (is_null($project))
            <p class="attribute">
