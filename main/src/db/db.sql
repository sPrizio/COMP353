...
INSERT INTO `department` VALUES (1,'Support',41,'2016-01-01'),(2,'Human Resources',89,'1998-04-26'),(3,'Engineering',36,'2004-05-08'),(4,'Marketing',95,'2010-03-03'),(5,'Sales',69,'2017-07-12'),(6,'Product Management',57,'1996-01-25'),(7,'Business Development',22,'1998-06-30'),(8,'Research and Development',82,'2008-02-11'),(9,'Training',1,'2009-11-11'),(10,'Accounting',51,'2015-12-12');
...
CREATE TABLE `located_in` (
  ...
  `department_id` int(11) unsigned NOT NULL,
  KEY `location_id_FOREIGN` (`location_id`),
  KEY `department_id_FOREIGN-A` (`department_id`),
...
CREATE TABLE `responsible_for` (
  ...
  KEY `department_id_FOREIGN-B` (`department_id`),
  KEY `project_id_FOREIGN-B` (`project_id`),
...
CREATE TABLE `role` (
  ...
  KEY `supervisor_id_FOREIGN-B` (`supervisor_id`),
...
INSERT INTO `role` VALUES (1,7),(33,7),(63,7),(98,7),(126,7),(152,7),(180,7),(2,11),(34,11),(64,11),(99,11),(127,11),(153,11),(181,11),(3,17),(35,17),(65,17),(100,17),(128,17),(154,17),(182,17),(4,18),(36,18),(67,18),(101,18),(129,18),(155,18),(183,18),(11,20),(41,20),(46,20),(159,20),(170,20),(5,28),(38,28),(69,28),(102,28),(130,28),(156,28),(184,28),(6,31),(39,31),(71,31),(103,31),(131,31),(157,31),(185,31),(8,37),(40,37),(73,37),(104,37),(132,37),(158,37),(186,37),(9,41),(42,41),(74,41),(105,41),(133,41),(160,41),(187,41),(10,46),(43,46),(75,46),(106,46),(134,46),(161,46),(188,46),(12,51),(44,51),(76,51),(107,51),(135,51),(162,51),(189,51),(18,52),(31,52),(37,52),(68,52),(94,52),(13,66),(45,66),(78,66),(108,66),(136,66),(163,66),(190,66),(14,68),(47,68),(80,68),(109,68),(137,68),(164,68),(191,68),(15,70),(48,70),(81,70),(110,70),(138,70),(165,70),(192,70),(16,72),(49,72),(82,72),(111,72),(139,72),(166,72),(193,72),(19,77),(50,77),(83,77),(112,77),(140,77),(167,77),(194,77),(51,79),(70,79),(77,79),(123,79),(141,79),(21,87),(53,87),(84,87),(113,87),(142,87),(168,87),(195,87),(22,94),(54,94),(85,94),(114,94),(143,94),(169,94),(196,94),(23,96),(55,96),(86,96),(116,96),(144,96),(172,96),(197,96),(17,97),(66,97),(87,97),(96,97),(171,97),(7,115),(28,115),(72,115),(125,115),(200,115),(24,123),(56,123),(88,123),(117,123),(145,123),(173,123),(198,123),(25,125),(57,125),(89,125),(118,125),(146,125),(174,125),(199,125),(26,141),(58,141),(90,141),(119,141),(147,141),(175,141),(27,159),(59,159),(91,159),(120,159),(148,159),(176,159),(29,170),(60,170),(92,170),(121,170),(149,170),(177,170),(30,171),(61,171),(93,171),(122,171),(150,171),(178,171),(32,200),(62,200),(95,200),(124,200),(151,200),(179,200);
...
CREATE TABLE `works_on` (
  ...
  KEY `project_id_FOREIGN-A` (`project_id`),
  KEY `employee_id_FOREIGN-A` (`employee_id`),
...
-- Dump completed on 2018-04-09 22:15:32
